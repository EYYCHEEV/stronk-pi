...
Automated validation final-output guard: after completing the prompt, your final answer must include every literal STATUS_TOKEN and boolean proof line requested by the prompt. Do not replace required tokens with a prose summary.
